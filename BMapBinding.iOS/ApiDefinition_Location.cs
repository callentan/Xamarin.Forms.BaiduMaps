...
namespace BMapBinding
{
    ...
    interface BMKWalkCycleLocationServiceDelegate
    {
    ...
    [BaseType(typeof(NSObject))]
    interface BMKWalkCycleLocationService
    {
        ...
        [Wrap("WeakDelegate")]
        BMKWalkCycleLocationServiceDelegate Delegate { get; set; }

        // @property (nonatomic, weak) id<BMKWalkCycleLocationServiceDelegate> delegate;
